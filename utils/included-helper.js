 ...
 * A helper class for managing the `included` member of a JSON API response.
 *
 * This is the `utils/included helper` module's default export.
 *
 ...
 * @returns {boolean} `true` if a resource was push to the helper's `included` array. `false` otherwise.
 */
 ...
 * @returns {count | boolean} A count of the resources added or a boolean
 ...
 *
 * @returns {array} Array of JSON API resources.  May be empty.
 */
